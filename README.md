...
Here is a comprehensive and professionally formatted `README.md` file for your GitHub repository. It is designed to match the high standards of an open-source release accompanying a top-tier IEEE journal publication.

It covers the theoretical background, the repository structure, installation instructions, and provides a citation block for your manuscript.
